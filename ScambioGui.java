...
public class ScambioGui extends JFrame{
    ...
    private  JButton   exitButton1,exitButton2;
   ...
   private void initComponents() {
	   ...
	   exitButton1=new JButton("Esci dallo scambio");
	   exitButton2=new JButton("Esci dallo scambio");
   ...
   private void formatComponents(){
       ...
       commandPanel1.setLayout(new GridLayout(4,1));
       commandPanel2.setLayout(new GridLayout(4,1));
       ...
       commandPanel1.add(exitButton1);
       commandPanel2.add(exitButton2);
   ...
   private void mapComponents(){
	   ...
	   componentMap.put(this.exitButton1,6);
	   componentMap.put(this.exitButton2,7);
   ...
   private void actionComponents(){
	   ...
	   this.exitButton1.addActionListener(controller);
	   this.exitButton2.addActionListener(controller);
